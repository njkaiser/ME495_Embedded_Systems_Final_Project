...
def ar_tag_track(data):
    ...
    for m in data.markers:
        drink_number = int(m.id)
        if drink_number == 0:
            return
        else:
            if drink_number == 3333:
                p.header.frame_id = 'gin'

            elif drink_number == 4444:
                p.header.frame_id = 'vodka'

            elif drink_number == 5555:
                p.header.frame_id = 'red bull'

            elif drink_number == 6666:
                p.header.frame_id = 'tonic'

            elif drink_number == 7777:
                p.header.frame_id = 'jager'
...
if __name__ == '__main__':
    try:
        ...
        drink_pos_pub = rospy.Publisher('drink_position', PointStamped, queue_size=1)
        ...
        # subscribe to ar_track_alvar for ar_tag
