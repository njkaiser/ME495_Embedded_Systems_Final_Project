...
class window_with_trackbars(object):
    ...
    def nothing(self, x):
        ...
        # might as well print out the trackbar value at least
...
def filter_red(img_hsv):
    ...
    red = cv2.bitwise_and(img_hsv, img_hsv, mask=red)
    return red
...
def callback(ros_img):
    ...
    img_raw = bridge.imgmsg_to_cv2(ros_img, desired_encoding="passthrough")
...
if __name__ == '__main__':
    try:
        ...
        red_tb_defaults = [0, 0, 0, 35, 50, 255, 170, 0, 0, 179, 255, 255]
